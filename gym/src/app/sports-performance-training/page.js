...
//       {/* EMS Block (Power of EMS subset) */}
//       <section id="ems" className="pt-32 md:pt-40">
//         <div className="max-w-5xl mx-auto px-6 md:px-10">
//           <h2 className={`${anton.className} uppercase leading-[0.9] text-4xl md:text-5xl xl:text-6xl mb-10`}>Power of EMS Training</h2>
//           <div className="space-y-10">
//             <div className="space-y-6">
//               <div>
//                 <h3 className="text-xl font-semibold mb-3">What is EMS Training?</h3>
//                 <p className="text-black/70 text-sm md:text-base leading-7">EMS (Electro Muscle Stimulation) Training is a revolutionary fitness method that enhances the effectiveness of every workout. By sending safe, low-frequency electrical impulses directly to the muscles, EMS achieves deeper muscle activation and superior results compared to traditional training.</p>
//               </div>
//               <div>
//                 <h3 className="text-xl font-semibold mb-3">How EMS Works</h3>
//                 <p className="text-black/70 text-sm md:text-base leading-7">Special Suit with Electrodes: During each session, clients wear a specially designed EMS suit equipped with electrodes. Muscle Activation: These electrodes send impulses that mimic the natural signals from the brain, causing muscles to contract. Combined with Movement: While the suit stimulates the muscles, guided exercises are performed to maximize results. Time Efficiency: A 20-minute EMS session is equivalent to 2–3 hours of conventional strength training.</p>
//               </div>
//               <div className="grid sm:grid-cols-3 gap-4">
//                 {[['Session Duration','20 minutes'],['Frequency','2x per week'],['Effectiveness','= 2–3h traditional']].map(item => (
//                   <div key={item[0]} className="p-5 bg-white rounded-2xl shadow-sm ring-1 ring-black/10">
//                     <p className="text-[11px] uppercase tracking-wide text-black/60 mb-1">{item[0]}</p>
//                     <p className="text-sm font-medium text-black leading-5">{item[1]}</p>
//                   </div>
//                 ))}
//               </div>
//             </div>
...
//               <div className="space-y-6">
//                 {[
//                   ['Maximum Muscle Activation',[ 'Activates up to 95% of muscle fibers simultaneously.','Engages deeper muscles that are often missed during normal workouts.' ]],
//                   ['Fast & Time-Saving',[ 'Just two 20-minute sessions per week deliver visible results.','Perfect for busy individuals with limited time.' ]],
//                   ['Fat Loss & Body Sculpting',[ 'Boosts metabolism, burns calories, and reduces body fat.','Tones and shapes muscles while tightening skin.' ]],
//                   ['Posture & Back Care',[ 'Strengthens stabilizing muscles, improving posture.','Reduces back pain and corrects muscular imbalances.' ]],
//                   ['Safe & Gentle',[ 'Low-impact on joints and ligaments.','Suitable for beginners, seniors, and rehabilitation training.' ]],
//                   ['Athletic Performance & Recovery',[ 'Improves strength, speed, and endurance.','Supports faster recovery after intense workouts.' ]],
//                 ].map(section => (
//                   <div key={section[0]} className="p-6 rounded-3xl bg-white shadow-sm ring-1 ring-black/10">
//                     <p className="font-semibold text-black mb-3">{section[0]}</p>
//                     <ul className="space-y-2 text-sm text-black/70 leading-5">
...
//             </div>
//             <div>
//               <h3 className="text-xl font-semibold mb-6">Who Can Benefit?</h3>
...
//                 ].map(item => (
//                   <div key={item[0]} className="p-5 rounded-2xl bg-white shadow-sm ring-1 ring-black/10">
//                     <p className="font-semibold text-black mb-1 text-sm md:text-base">{item[0]}</p>
//                     <p className="text-[13px] md:text-sm text-black/60 leading-5">{item[1]}</p>
//                   </div>
//                 ))}
//               </div>
//             </div>
//             <div className="p-6 md:p-8 rounded-3xl bg-gradient-to-br from-[#76C043]/10 to-white ring-1 ring-black/10">
//               <h3 className="text-xl font-semibold mb-4">Why Choose EMS Training?</h3>
//               <p className="text-sm md:text-base text-black/70 leading-7 mb-4">EMS Training is not just a workout — it’s a smarter way to train. With scientifically proven benefits, it compresses hours of effort into minutes while delivering visible results. Whether your goal is fat loss, muscle tone, recovery, or peak performance, EMS helps you achieve it efficiently.</p>
//               <p className="text-sm font-medium text-black flex items-center gap-2">⚡ <span>20 minutes. Twice a week. Real transformation.</span></p>
//             </div>
//           </div>
//         </div>
//       </section>
