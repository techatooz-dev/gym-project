    ...
    <section className="relative py-12 md:py-20">
      <div className="max-w-7xl mx-auto px-6 lg:px-10 flex flex-col gap-10">
        <div className="max-w-3xl">
          <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-green-600 mb-4">
            Precision EMS Training
          </h2>
          <p className="text-sm md:text-base text-gray-600 leading-relaxed">
            Purpose‑built protocols combining neuromuscular activation with safe movement patterns for faster adaptation and sustainable performance.
          </p>
        </div>
