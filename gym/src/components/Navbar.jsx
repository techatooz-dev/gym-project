                                ...
                                if (link.href === "/services") {
                                    return (
                                        ...
                                        >
                                            <Link
                                                href={link.href}
                                                className="px-3 py-2 rounded-md text-sm font-semibold uppercase tracking-wide transition-colors text-gray-700 hover:text-green-700 dark:text-gray-300 dark:hover:text-white inline-flex items-center gap-1"
                                            >
                                                {link.label}
                                                <svg className="w-3.5 h-3.5 text-green-600 transition-transform duration-200 group-hover:rotate-180" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden>
                                                    <path d="M6 9l6 6 6-6" />
                                                </svg>
                                            </Link>
                                            <div
                                                className={`absolute left-0 top-full w-72 rounded-md border border-green-200 bg-white shadow-lg z-50 ${servicesOpen ? "block" : "hidden"}`}
                                            >
                                                {/* Arrow pointer */}
