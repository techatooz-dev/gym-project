...
function Wellness() {
  return (
    <section className="w-full bg-white  mb-14 md:mb-0">
      <div className="max-w-7xl grid md:grid-cols-12 gap-12 items-center">
        ...
        {/* Right: Text */}
        <div className="md:col-span-6 text-center md:text-left px-[16px] py-[8px] md:px-0 md:py-0">
          <h3 className={`${anton.className} text-5xl sm:text-5xl md:text-6xl lg:text-7xl leading-tight md:leading-[0.95] font-bold uppercase tracking-[0.05em] mb-6 md:mb-8`}>
            Pain Relief &
            <br />
            Wellness
          </h3>
          <p className="text-slate-700 text-sm md:text-base leading-7 md:leading-8 max-w-xl mx-auto">
